...
**Pro tip:** in your extension to the Chrome toolbar for easy access by clicking the pin button.

![](/screenshots/popup_example.png)

## Where is the manifest.json file?

It will be generated on-the-fly for you. Plasmo generates the manifest based on your source files and configurations you export from your code - similar to how [Next.js](https://nextjs.org/) abstracts page routing and SSG with the file system and page components.
