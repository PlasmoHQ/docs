...
The command above will create a project with the [options page](adding-the-options-ui), a [newtab page](browser-extension#adding-a-new-tab-page), and an [inline content script UI]().
