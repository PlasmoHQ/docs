...
You can use the `url:` scheme to load extra source code to be used in web-accessible resources.

Web-accessible resources can be helpful if you'd like to reference static content from your content script and the `data-base64` or `data-text` schemes don't align with what you're looking for.
...
So you can access that Javascript file however you'd like!
