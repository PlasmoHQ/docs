...
- [Declarative Development](/framework#where-is-the-manifestjson-file)
- [Content Scripts UI](/csui)
- [Tab Pages](/framework/tab-pages)
- Live-reloading + React HMR
- [`.env*` files](/framework/env)
- Targeting [multiple browser and manifest pairs](/framework/workflows/build#with-specific-target)
- [Remote code bundling](/framework/remote-code) (e.g., for gtag4)
- [Automated deployment via BPP](/framework/workflows/submit)
