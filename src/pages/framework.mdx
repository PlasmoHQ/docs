...
| First-class [React](https://reactjs.org/) + [Typescript](https://www.typescriptlang.org/) Support | [Declarative Development](/framework#where-is-the-manifestjson-file)                                                   |
| :------------------------------------------------------------------------------------------------ | :--------------------------------------------------------------------------------------------------------------------- |
| [Content Scripts UI](/csui)                                                                       | [Tab Pages](/framework/tab-pages)                                                                                      |
| Live-reloading + React HMR                                                                        | [`.env*` files](/framework/env)                                                                                        |
| [Storage API](/framework/storage)                                                                 | [Messaging API](/framework/messaging)                                                                                  |
| Targeting [multiple browser and manifest pairs](/framework/workflows/build#with-specific-target)  | [Remote code bundling](/framework/remote-code) (e.g., for gtag4)                                                       |
| [Automated deployment via BPP](/framework/workflows/submit)                                       | Optional support for [Svelte](https://github.com/PlasmoHQ/with-svelte) and [Vue](https://github.com/PlasmoHQ/with-vue) |
| And many, many more! 🚀                                                                           |                                                                                                                        |
...
| `package.json`    | Your usual Node.js project descriptor, with [an optional "manifest" property to customize Plasmo to your need](/framework/customization/manifest) |
...
Check out the rest of the [Framework section](/framework/ext-pages) for a deep dive into how to work with Plasmo. A modular example accompanies each workflow, showcasing the framework's simplicity. View examples on [our GitHub repo](https://github.com/PlasmoHQ/examples).
