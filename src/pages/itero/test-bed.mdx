...
If you're using GitHub to manage your code, Itero TestBed can be integrated with it. This allows you to automatically deploy your browser extensions to Itero TestBed when you push to your GitHub repository. Visit the [GitHub Builder page](./itero/builder) page for more information.
