...
To import CSS/LESS/SASS files, combine the `getStyle` API with the [`data-text` import scheme](browser-extension/import#data-text):
...
To inherit the web page's style, override the built-in `Root Container` to mount your component directly into the web page's DOM. [Click here for more details](/browser-extension/content-scripts-ui/life-cycle#custom-root-container).
