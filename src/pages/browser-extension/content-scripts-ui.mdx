...
0. If you have a `content.ts` file, rename it to `contents/stuff.tsx`
1. Create a new content script inside `contents` directory with the `.tsx` extension: `contents/inline.tsx`
