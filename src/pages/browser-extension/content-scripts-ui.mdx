...
Content scripts UI are a special sub-set of content scripts. Thus, you can also [export a config object](/browser-extension/content-scripts#config).
...
2. Create a `font.css` file, importing the font inline using the `data-base64` scheme:
