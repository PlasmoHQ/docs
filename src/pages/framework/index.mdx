...
- Optional support for [Svelte](https://github.com/PlasmoHQ/examples/tree/main/with-svelte) and [Vue](https://github.com/PlasmoHQ/examples/tree/main/with-vue), and [a lot of other tools](https://github.com/PlasmoHQ/examples)
