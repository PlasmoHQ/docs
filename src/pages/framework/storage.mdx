...
Once your extension is published, the Add-on ID defined in the `package.json` file will be displayed in your extension's Developer Page under "Technical Details > UUID".
