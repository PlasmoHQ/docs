...
For the time being, if you'd like to build for Safari, you can target `firefox-mv2` and use the [safari-web-extension-converter](https://developer.apple.com/documentation/safariservices/safari_web_extensions/converting_a_web_extension_for_safari) to convert the extension to Safari.
