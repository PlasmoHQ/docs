...
<Callout emoji="⚠️">
  These flags may cause your extension to not function OR not be accepted by the browser
  vendor's web stores such as Chrome and Edge.
</Callout>


To create a bundle with minified, optimized and potentially obfuscated code:
...
Note that hoisting can potentially break your dependency, especially those that import dynamic dependency via a plugin system. However, hoisting can improve your bundling speed.
