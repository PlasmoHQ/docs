...
Plasmo offers first-class support for environment variables. This allows you to customize your extension to fit the need of each browser/environment from the same codebase.
