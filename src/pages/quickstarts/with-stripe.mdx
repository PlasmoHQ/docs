...
Assuming you have set up a basic Plasmo project, the first thing to do is to set up our [environment variables](/workflows/env):
...
We can then use this key by leveraging [env variable in our manifest override](/workflows/env#using-env-in-manifest-overrides):
